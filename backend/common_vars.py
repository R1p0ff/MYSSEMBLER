...
assembly_labels_regex = r"^\s*([a-zA-Z_][a-zA-Z0-9_]*):"
...
# RISC V
risc5_headers_regex =r"^\s*\.[a-zA-Z0-9_]+"

risc5_labels_regex =r"^\s*([a-zA-Z0-9_]+):"

risc5_operations_regex =r"^\s*([a-z]+)\s+([^,\s]+)(?:\s*,\s*([^,\s]+))?(?:\s*,\s*([^,\s]+))?"
